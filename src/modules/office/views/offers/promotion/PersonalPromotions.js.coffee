@Iconto.module 'office.views.offers', (Offers) ->
	...
	class Offers.PersonalPromotionItemView extends Marionette.ItemView
		className: 'personal-cashback-item-view request-item-view'
		template: JST['office/templates/offers/promotion/personal-promotion-item']
	...
	class Offers.PersonalPromotionsView extends Iconto.shared.views.infinite.BaseInfiniteCompositeView
		...
		childView: Offers.PersonalPromotionItemView
